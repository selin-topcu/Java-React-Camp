...
public class NAWKPSPublicSoap
{
    ...
    public NAWKPSPublicSoap(){}

    public NAWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public NAWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        NAWExtendedSoapSerializationEnvelope envelope= new NAWExtendedSoapSerializationEnvelope(NAWExtendedSoapSerializationEnvelope.VER11);
