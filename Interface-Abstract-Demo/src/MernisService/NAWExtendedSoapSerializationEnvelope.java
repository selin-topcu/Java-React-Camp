...
public class NAWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(NAWDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new NAWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static NAWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static NAWDateTimeConverter dateTimeConverter = new NAWStandardDateTimeConverter();

    public NAWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public NAWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new NAWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=NAWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,NAWExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=NAWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
