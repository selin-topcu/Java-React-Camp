...
public class CLVKPSPublicSoap
{
    ...
    public CLVKPSPublicSoap(){}

    public CLVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CLVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CLVExtendedSoapSerializationEnvelope envelope= new CLVExtendedSoapSerializationEnvelope(CLVExtendedSoapSerializationEnvelope.VER11);
