...
public class CLVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CLVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new CLVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CLVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CLVDateTimeConverter dateTimeConverter = new CLVStandardDateTimeConverter();

    public CLVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CLVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CLVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CLVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CLVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CLVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
