...
public class JLNKPSPublicSoap
{
    ...
    public JLNKPSPublicSoap(){}

    public JLNKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public JLNKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        JLNExtendedSoapSerializationEnvelope envelope= new JLNExtendedSoapSerializationEnvelope(JLNExtendedSoapSerializationEnvelope.VER11);
