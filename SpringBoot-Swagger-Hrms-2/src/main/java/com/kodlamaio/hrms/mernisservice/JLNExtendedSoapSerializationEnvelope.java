...
public class JLNExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(JLNDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new JLNStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static JLNDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static JLNDateTimeConverter dateTimeConverter = new JLNStandardDateTimeConverter();

    public JLNExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public JLNExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new JLNMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=JLNHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,JLNExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=JLNHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
